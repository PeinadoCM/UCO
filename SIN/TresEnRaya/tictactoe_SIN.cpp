			...
			if (pair.second) {
				...
				if(iWon){
					...
					if(total > MAXOCCURRENCES){
						srand(time(NULL));
						int aleat=rand()%2;
						if(pair.first->numTies > MINOCCURRENCES && aleat == 0){
							pair.first->numTies--;
						}
						else if(pair.first->numLost > MINOCCURRENCES && aleat == 1){
							pair.first->numLost--;
						}
					}
				}
					...
					if(total > MAXOCCURRENCES){
						...
						else if(pair.first->numWins > MINOCCURRENCES && aleat == 1){
							pair.first->numWins--;
						}
					}	
				}
					...
					if(total > MAXOCCURRENCES){
						srand(time(NULL));
						int aleat=rand()%2;
						if(pair.first->numWins > MINOCCURRENCES && aleat == 0){
							pair.first->numWins--;
						}
						else if(pair.first->numLost > MINOCCURRENCES && aleat == 1){
							pair.first->numLost--;
