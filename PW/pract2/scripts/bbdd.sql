...
INSERT INTO `Jugadores` VALUES ('i22pecum@uco.es', 'Manuel Peinado Cuenca', '2004-12-01', '2024-10-29');
INSERT INTO `Jugadores` VALUES ('l30jogar@uco.es', 'Laura Jofré García', '2005-05-15', '2023-11-08');
INSERT INTO `Jugadores` VALUES ('p13sucre@uco.es', 'Pablo Suárez Crespo', '2003-07-22', '2021-03-20');
INSERT INTO `Jugadores` VALUES ('v19pemar@uco.es', 'Víctor Pérez Martín', '1995-09-09', '2020-12-13');
INSERT INTO `Jugadores` VALUES ('a45calon@uco.es', 'Ana Castillo Londoño', '1999-11-18', '2023-09-28');
INSERT INTO `Jugadores` VALUES ('j32doagu@uco.es', 'Javier Domínguez Aguilar', '2005-03-27', '2022-06-04');
...
INSERT INTO `Materiales` VALUES (1, 1, 'PELOTAS', 'DISPONIBLE');
INSERT INTO `Materiales` VALUES (2, 0, 'CONOS', 'RESERVADO');
INSERT INTO `Materiales` VALUES (3, 0, 'CANASTAS', 'DISPONIBLE');
INSERT INTO `Materiales` VALUES (4, 0, 'CANASTAS', 'MAL_ESTADO');
INSERT INTO `Materiales` VALUES (5, 1, 'PELOTAS', 'RESERVADO');
INSERT INTO `Materiales` VALUES (6, 1, 'PELOTAS', 'DISPONIBLE');

-- --------------------------------------------------------

-- 
-- Estructura de tabla para la tabla `Materiales_Pistas`
-- 

DROP TABLE IF EXISTS `Materiales_Pistas`;
CREATE TABLE IF NOT EXISTS `Materiales_Pistas` (
  `Id_material` int NOT NULL,
  `Nombre_pista` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id_material`, `Nombre_pista`),
...
-- 
-- Volcar la base de datos para la tabla `Materiales_Pistas`
-- 

INSERT INTO `Materiales_Pistas` VALUES (2, 'Basket1');
INSERT INTO `Materiales_Pistas` VALUES (5, 'Basket1');
